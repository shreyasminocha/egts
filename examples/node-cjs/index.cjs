...
const {
  ...
  PlaintextSelection,
  EncryptionDevice,
} = require('electionguard');
const manifestObj = require('../manifest.json');
const electionContextObj = require('../context.json');
...
const encryptor = AsyncBallotEncryptor.create(
  ...
  ballot.ballotId,
  codeSeed,
  context.createElementModQFromHex('13EE0734C0AADFFC11002A950CC6278B648B5AB3BFF098C4103FE0BABAA778C1'),
  1642028895
);
